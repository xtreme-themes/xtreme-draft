...
function draft_setup() {
     ...
     */
    add_image_size( 'slider', 960, 352, true );

    /*
     * add meta data - see functiondraft_meta below
     */
    //add_action('xtreme_meta', 'draft_meta');
    ...
    /*
     *  Size of Authorbox Avatar
     */
    add_filter( 'xtreme_authorbox_avatar_size', 'draft_author_box_gravatar_size' );
    add_filter( 'xtreme_author_avatar_size', 'draft_author_box_gravatar_size' );
...
function draft_author_box_gravatar_size( $size ) {
    return '60';
}
